...
public class EmailSender {
    ...
    private EmailSender() {
        EmailSender.config(EmailSender.SMTP_163(false), "fuy_blog@163.com", "SAPBDXAPWFIKVODH");
    }
    ...
    public static void sendRegisterVerifyCode(String code,String address) throws MessagingException {
        EmailSender.subject("犀牛空间博客系统注册验证码")
                .from("犀牛空间博客系统")
                .text("您的验证码是"+code+" ,请在10分钟内完成注册,若非本人操作请忽略此邮件")
                .to(address)
                .send();
    }
}
